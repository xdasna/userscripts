...
class Button extends HTMLElement {
	constructor(){
		...
		utils.add_ele('style', shadow, { textContent: __webpack_require__(/*! ./button.css */ "../libs/ez/button.css") });
...
var { Select, Option } = __webpack_require__(/*! ./select */ "../libs/ez/select.js"),
	...
	{ Button } = __webpack_require__(/*! ./button */ "../libs/ez/button.js");
...
var { utils, store } = __webpack_require__(/*! ../consts */ "../libs/ui/consts.js"),
	...
	Tab = __webpack_require__(/*! ./tab */ "../libs/ui/config/tab.js"),
...
class Main {
	...
	async load(){
		...
		this.ui = __webpack_require__(/*! ./settings */ "./settings.js");
...
var { api, utils, meta } = __webpack_require__(/*! ../libs/consts.js */ "../libs/consts.js"),
	...
	File = __webpack_require__(/*! ../libs/file */ "../libs/file.js"),
...
module.exports="main{display:flex;align-items:center;justify-content:center;height:100%;background:#FFF;border-radius:3px;background:#0078d4;padding:0px 10px}main:hover{background:#006cbe}main:active{background:#1683d8}"
